...
def create_coin_list_table(coins: List[Dict[str, Any]], currency: str = "usd") -> Table:
    ...
    for i, coin in enumerate(coins, 1):
        table.add_row(
            ...
            format_price_change(coin.get('price_change_percentage_7d_in_currency', 0)),
...
def create_coin_detail_panel(coin: Dict[str, Any], currency: str = "usd") -> Panel:
    ...
    content.append(
        format_price_change(coin['market_data'].get('price_change_percentage_24h', 0))
    )
    content.append("\n")
    ...
    if coin['market_data'].get('max_supply'):
        ...
        content.append(f"{format_large_number(coin['market_data']['max_supply'])}\n")
